...
@Injectable()
export class SubSectionGuardService extends BaseGuard implements CanActivate, CanDeactivate<CreateSubsectionComponent> {


    constructor(protected override router: Router,
        private translateService: TranslateService) { super(router); }

    canDeactivate(component: CreateSubsectionComponent) {
